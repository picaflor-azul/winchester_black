...
$db->Execute("INSERT IGNORE INTO " . TABLE_CONFIGURATION_GROUP . " (configuration_group_title, configuration_group_description, sort_order, visible) VALUES ('" . BOX_CONFIGURATION_WINCHESTER_BLACK. "', 'Set Winchester Black Template Options', '1', '1');");
$configuration_group_id = $db->Insert_ID();
...
$messageStack->add('Installed Winchester Black Template v1.3', 'success');
